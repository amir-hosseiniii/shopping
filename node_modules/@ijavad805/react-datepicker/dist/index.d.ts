...
declare const Datepicker: ({ theme, lang, input, format, modeTheme, adjustPosition, closeWhenSelectADay, value, footer, onChange, defaultValue, dayEffects, disabled, disabledDate, loading, onOpen, spinnerComponent, name, allowClear, onChangeMonth, }: IPropsDatepicker) => JSX.Element;
...
declare type IOnDateFunc = (date: string) => {
    className?: string;
};
interface IProps {
    lang?: "en" | "fa";
...
declare const Calender: ({ lang, theme, events, onDropEvent, onClickEvent, onDoubleClickEvent, style, onDateClick, onDay, onMonthChange, view, yearlyOptions, className, extra, onAddEventClick, }: IProps) => JSX.Element;
