...
export declare type eventsGroupType = {
    [key: string]: IEvent[];
};
...
declare const DatepickerProvider: ({ children, config, input, format, onChange, value, defaultValue, setOpen, closeWhenSelectADay, }: IProps) => JSX.Element;
